...
# --- Icon library (Sports Today icons v1; monochrome, currentColor) ---------
# Sourced from icons/sports_today_icons_v1/*.svg. Directional recent-form arrows
# are kept inline because the set ships one generic trend icon.
